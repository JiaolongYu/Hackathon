...
//    private SoundPool soundPool = new SoundPool.Builder().setAudioAttributes(attributes).build();
    ...
    void startGochaGame(boolean multiplayer) {
        mMultiplayer = multiplayer;
//        updateScoreDisplay();
//        broadcastScore(false);
        switchToScreen(R.id.parent);
...
//        audioManager.setStreamVolume(AudioManager.STREAM_MUSIC, audioManager.getStreamMaxVolume(AudioManager.STREAM_MUSIC), 0);
        ...
        rightHalf.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ImageView randomImage = new ImageView(CombatModeActivity.this);
    ...
    private class rightHandlerCallBack implements Handler.Callback {
        public boolean handleMessage(Message m) {
            final ImageView randomImage = new ImageView(CombatModeActivity.this);
...
//    }
    ...
    private void endGame() {
        ...
        quit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CombatModeActivity.this, FrontPageActivity.class);
                startActivity(intent);
            }
        });
...
//        }
    ...
    void broadcastEnd(boolean finalScore) {
        if (!mMultiplayer)
